...
Seja \(\Omega\) um aberto {\color{red} limitado } de \(\rd\). Então, existe \(C=C_{p,\Omega}\) tal que, para todo  \({\color{blue} p }\in [1,\dm)\), vale
\begin{equation*}
\n{u}_{{\color{blue} p },\Omega}\leq C\n{\nabla u}_{{\color{blue} p },\Omega},\ \forall u\in W_0^{1,{\color{blue} p }}(\Omega).
\end{equation*}
\end{teo}
...
\begin{obs}
\begin{enumerate}
\item A diferença com a desigualdade de imersão anterior é que temos apenas o gradiente de \(u \) aparece no lado direito.
...
Seja \(K\) um espaço métrico compacto e \(C(K)\) o conjunto das funções contínuas \(f:K\to \R\) com a norma do \(\sup\). Se um subconjunto \(\mathcal{B}\) de   \(C(K)\)  satisfaz:
\begin{enumerate}
\item \(\mathcal{B}\) é limitado em \(C(K)\);
\item \(\mathcal{B}\) é uniformemente equicontínuo, isto é, 
\[\forall\, \ep>0, \exists\, \delta>0 \text{ tal que } d(x_1,x_2)<\delta \Rightarrow |f(x_1)-f(x_2)|<\ep,\ \forall f\in \mathcal{B};\]
\end{enumerate}
então \(\mathcal{B}\) é relativamente compacto em \(C(K)\).
\end{teo}
\end{frame}
...
Seja \(\mathcal{F}\) um subconjunto de \(L^p(\rd)\), com \(1\leq p<\infty\). Se 
\begin{enumerate}
\item \(\mathcal{F}\) é limitado em \(L^p(\rd)\);
\item \(\lim\limits_{|h|\to 0}\|\tau_hu-u\|_{p,\rd}=0\) uniformemente em \(\mathcal{F}\), isto é, 
\[\forall\, \ep>0, \exists\, \delta>0 \text{ tal que } |h|<\delta \Rightarrow \|\tau_hu-u\|_{p,\rd}<\ep,\ \forall u\in \mathcal{F}.\]
\end{enumerate}
Então \(\mathcal{F}\big\vert_\Omega\) é relativamente compacto em \(L^p(\Omega)\), para qualquer \(\Omega\subset \rd\) com medida finita. 
\end{teo}
...
Seja \(\Omega \subset \rd\) um aberto limitado com fronteira de classe \(C^1\). Então as seguintes imersões são compactas:
\begin{enumerate}
\item \(W^{1,p}(\Omega)\ic L^q(\Omega) \), \(1\leq q <p^\ast\), se \(p<\dm\),
\item \(W^{1,\dm}(\Omega)\ic L^q(\Omega) \), \(1\leq q <\infty\), se \(p=\dm\),
\item \(W^{1,p}(\Omega)\ic C^{0,\gamma}(\overline{\Omega}) \), \(1\leq q <p^\ast\), se \(p>\dm\),
\end{enumerate}
\end{teo}
