...
\bibitem[Bhattacharyya, 2012]{Bhat}
Bhattacharyya, Pulin K.
\newblock {\em Distributions: generalized functions with applications in Sobolev spaces}
\newblock De Gruyter, Berlin/Boston, 2012. 
...
Folland, Gerald B.
\newblock {\em  Real Analysis: Modern Techniques and Their Application}
\newblock John Wiley \& Sons,  $2^\text{nd}$ ed, 1999. 
