...
B4=B4.elementary_row_op(op='n->n+km', row=1, k=-2, row1=None, row2=2)


# 5a eliminacao da matriz B
B5=B4.elementary_row_op(op='n->kn', row=0, k=3, row1=None, row2=None)
B5=B5.elementary_row_op(op='n->n+km', row=0, k=-2, row1=None, row2=3)

B5=B5.elementary_row_op(op='n->kn', row=1, k=3, row1=None, row2=None)
B5=B5.elementary_row_op(op='n->n+km', row=1, k=1, row1=None, row2=3)

B5=B5.elementary_row_op(op='n->kn', row=2, k=3, row1=None, row2=None)
B5=B5.elementary_row_op(op='n->n+km', row=2, k=-2, row1=None, row2=3)
...
\begin{tabu}{c}
L_1\rightarrow L_1+L_3\\
L_2\rightarrow 3L_2+2L_3\\
\end{tabu}
}
\pyl{B4}
{\footnotesize
\begin{tabu}{c}
L_1\rightarrow 3L_1-2L_4\\
L_2\rightarrow 3L_2+L_4\\
L_3\rightarrow 3L_2-2L_4\\
\end{tabu}
}
\]
\[
