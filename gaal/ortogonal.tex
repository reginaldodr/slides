...
Uma matriz  $A$ quadrada com entradas reais  é ortogonalmente diagonalizável se, e somente se, $A$ é simétrica. Além disso, autovetores associados a autovalores distintos são ortogonais.
\end{block}
