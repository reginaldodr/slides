...
\item Uma matriz é invertível se, e somente se, é linha-equivalente à matriz identidade.
...
\[A^{-1}=\pyl{invA},\ 
B^{-1}=\begin{pmatrix}
\pyl{invB[0,0]} & \pyl{invB[0,1]} & \pyl{invB[0,2]}  & \pyl{invB[0,3]}  \\[0.5em]
\pyl{invB[1,0]} & \pyl{invB[1,1]} & \pyl{invB[1,2]}  & \pyl{invB[1,3]}  \\[0.5em]
\pyl{invB[2,0]} & \pyl{invB[2,1]} & \pyl{invB[2,2]}  & \pyl{invB[2,3]}  \\[0.5em]
\pyl{invB[3,0]} & \pyl{invB[3,1]} & \pyl{invB[3,2]}  & \pyl{invB[3,3]}  
\end{pmatrix}.\]
